...
// Add effect to prevent layout shift when opening context menu
...
>(({ className, children, ...props }, ref) => (
  <ContextMenuPrimitive.Portal>
    ...
    >
      {children}
      <ContextMenuPrimitive.Arrow className="fill-popover" />
    </ContextMenuPrimitive.Content>
  </ContextMenuPrimitive.Portal>
))
...
>(({ className, inset, children, ...props }, ref) => (
  <ContextMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(
      "group relative flex cursor-default select-none items-center rounded-sm px-2.5 py-1.5 text-sm outline-none focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      inset && "pl-8",
      className
    )}
    {...props}
