  ...
  return (
    <>
      <Button
        ...
        className="fixed bottom-6 left-6 h-14 w-14 rounded-full bg-cow-purple shadow-lg z-40 hover:bg-cow-purple-dark"
      >
        <div className="pixel-art-coffee">
          <div className="pixel-art-coffee-mug" />
          <div className="pixel-art-coffee-steam" />
        </div>
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogContent className="pixel-corners border-2 border-cow-purple">
          <DialogHeader>
            ...
            <DialogDescription>
              Support Creator On Wheels to keep everything 100% free for
              everyone!
            </DialogDescription>
          </DialogHeader>
          <div className="flex flex-col items-center space-y-4 py-4">
            <img
              ...
              alt="Coffee cup"
              className="pixel-corners h-32 w-32 rounded-md object-cover"
            />
            <p className="text-center">
              Your support helps us create more free resources for content
              creators!
            </p>
            <a
              ...
              className="pixel-btn-primary flex w-full items-center justify-center space-x-2"
            >
              <div className="pixel-art-coffee-small mr-2" />
