...
export default async function handler(
  ...
  const { description, creativity } = req.body as GenerateTitlesRequestBody; // Cast req.body here
  ...
  try {
    ...
    // Use type assertion for stringify keys as it expects an object
    ...
    const openAIError = error as OpenAIClientError; // Type assertion to check for specific properties
