  ...
  return (
    <section className="relative h-screen flex items-center overflow-hidden cow-grid-bg pt-20 md:pt-24">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('https://images.unsplash.com/photo-1605490005049-7c7ab3b5bb05?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2670&q=80')",
      ...
      {/* Main content */}
      <div
        className="container relative z-20 mx-auto px-4 flex flex-col items-center md:items-start"
