...
import { Music, Image, Video, FileText, Search, Filter, Copy, Check, FileAudio, Download, Play, Pause, Volume2 } from 'lucide-react';
...
interface Resource {
  id: number;
  title: string;
  category: 'music' | 'sfx' | 'image' | 'animation' | 'video' | 'font' | 'preset';
...
const mockResources: Resource[] = [
  {
    id: 1,
    title: 'Epic Minecraft Adventure Theme',
    category: 'music',
    downloadUrl: '#',
    author: 'MusicMaster',
  ...
  {
    id: 2,
    title: 'Cyberpunk Minecraft Background Pack',
    category: 'image',
    downloadUrl: '#',
    previewUrl: 'https://images.unsplash.com/photo-1611488006004-29f6cd3a06de?auto=format&fit=crop&q=80&w=2070'
  },
  {
    id: 3,
    title: 'Cinematic Minecraft Color Grade',
    category: 'preset',
    subcategory: 'davinci',
    downloadUrl: '#',
    author: 'ColorGrader'
  ...
  {
    id: 4,
    title: 'Minecraft Whoosh Transitions',
    category: 'sfx',
    downloadUrl: '#',
  ...
  {
    id: 5,
    title: 'Minecraft Pixel Art Font',
    category: 'font',
    downloadUrl: '#',
    author: 'FontDesigner',
  ...
  {
    id: 6,
    title: 'Minecraft Lower Thirds Pack',
    category: 'animation',
    downloadUrl: '#',
  ...
  {
    id: 7,
    title: 'Minecraft Vlog Transitions',
    category: 'preset',
  ...
  {
    id: 8,
    title: 'Minecraft Ambient Background Music',
    category: 'music',
    downloadUrl: '#',
  ...
  {
    id: 9,
    title: 'Minecraft Tutorial Video Template',
    category: 'video',
    downloadUrl: '#',
    previewUrl: 'https://example.com/tutorial.mp4'
  }
];
...
const AudioPlayer = ({ url }: { url: string }) => {
  ...
  return (
    <div className="audio-player-container">
      ...
      <div className={`audio-visualizer audio-visualizer-animated ${isPlaying ? 'playing' : ''}`}>
        {bars}
      </div>
            ...
            <div className="mb-8 flex flex-col md:flex-row gap-4">
              ...
              {isMobile ? (
                <Sheet>
                  ...
                  <SheetContent side="bottom" className="h-[60vh] pixel-corners">
          ...
          <div className="space-y-6 py-4">
            ...
            {selectedResource?.previewUrl && (
              <div className="border border-border rounded-md p-4">
                ...
                ) : selectedResource.category === 'video' || selectedResource.category === 'animation' ? (
