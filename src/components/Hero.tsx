...
const Hero = () => {
  ...
  return (
    <section className="relative h-screen flex items-center overflow-hidden cow-grid-bg pt-32 md:pt-24">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('https://images.unsplash.com/photo-1622737133809-d95047b9e673?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8bWluZWNyYWZ0fGVufDB8fDB8fHww')",
      ...
      <div
        ...
        style={{
          backgroundImage:
            'linear-gradient(to bottom, rgba(155, 135, 245, 0.1) 1px, transparent 1px), linear-gradient(to right, rgba(155, 135, 245, 0.1) 1px, transparent 1px)',
          ...
          {Array.from({ length: 6 }).map((_, index) => (
            <div
              ...
              className={`absolute ${
                index % 2 === 0
                  ? 'bg-cow-purple/20'
                  : 'border-2 border-cow-purple/20'
              } rounded-lg pixel-corners`}
              style={{
                ...
                transform: `translate(${
                  scrollY * 0.1 * (index - 3) + mousePosition.x * (index * 5)
                }px, ${
                  -scrollY * 0.05 * (index - 3) + mousePosition.y * (index * 5)
                }px) rotate(${scrollY * 0.02 * index}deg)`,
                transition: 'transform 0.1s ease-out',
      ...
      <div className="container relative z-20 mx-auto px-4 flex flex-col items-center md:items-start">
        <h1
          ...
          style={{
            ...
            transform: `translateY(${mousePosition.y * -5}px) translateX(${
              mousePosition.x * -5
            }px)`,
            transition: 'transform 0.1s ease-out',
          }}
        ...
        <p
          ...
          style={{
            transform: `translateY(${mousePosition.y * -3}px) translateX(${
              mousePosition.x * -3
            }px)`,
            transition: 'transform 0.1s ease-out',
          }}
        ...
        <div
          ...
          style={{
            transform: `translateY(${mousePosition.y * -2}px) translateX(${
              mousePosition.x * -2
            }px)`,
            transition: 'transform 0.1s ease-out',
          }}
        ...
        <p
          ...
          style={{
            transform: `translateY(${mousePosition.y * -1}px) translateX(${
              mousePosition.x * -1
            }px)`,
            transition: 'transform 0.1s ease-out',
          }}
