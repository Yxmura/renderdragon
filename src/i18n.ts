    ...
    translation: {
      community: {
        ...
        tutorials: {
          1: {
            name: 'How to Make Thumbnails',
            description: 'Learn how to make eye-catching Minecraft thumbnails that generate clicks'
          },
          2: {
            name: 'How to Edit in Premiere Pro',
            description: 'Tutorials for editing Minecraft videos in Adobe Premiere Pro and After Effects'
          },
          3: {
            name: 'How to Edit in DaVinci Resolve',
            description: 'Tutorials for editing Minecraft videos in DaVinci Resolve'
        ...
        servers: {
          ...
          description: 'Join these communities to connect with other creators, get feedback, and learn new skills.',
          joinButton: 'Join Server',
          serverIconAlt: 'Server icon {name}',
          servers: {
            1: {
              description: 'The Creator Coaster server will be your best friend throughout your content creation journey, with professional editors and artists ready to help you with anything you need!'
            },
            2: {
              description: 'Minecraft Design Hub is run by qualified designers with extensive experience in the GFX industry, offering designs, games, and community support.'
            },
            3: {
              description: 'Thumbnailers is a thriving community for Minecraft thumbnail designers of all levels, offering resources and feedback to improve your designs.'
            },
            4: {
              description: 'EditHub is the ultimate hub for content creation for editors, designers, and creators looking to grow and improve their skills.'
            },
            5: {
              description: 'Our official Discord server where you can suggest resources, contact us with questions or suggestions, and connect with the community.'
            }
          }
        },
        categories: {
        ...
        toast: {
          description: 'You will be redirected to Discord'
        }
      }
    }
  },
  es: {
    translation: {
      community: {
        ...
        description: 'Conéctate con otros creadores, obtén retroalimentación y encuentra recursos en estas comunidades de Discord activas.',
        tabs: {
          tutorials: 'Tutoriales',
          servers: 'Servidores de Discord'
        },
        ...
        servers: {
          title: 'Servidores de Discord Recomendados',
          description: 'Únete a estas comunidades para conectarte con otros creadores, obtener retroalimentación y aprender nuevas habilidades.',
          joinButton: 'Unirse al Servidor',
          serverIconAlt: 'Icono del servidor {name}',
          servers: {
            1: {
...
export const getI18n = async (): Promise<I18nType> => {
...
// Initialize i18n immediately for server-side rendering
export const initializeI18nForSSR = async (lng = 'en') => {
